...
export class LogicNodeExecutor extends BaseExecutor {
  protected registerHandlers(): void {
    ...
    this.registerHandler('constants', executeConstantsNode as LogicExecutorHandler);
    ...
    this.registerHandler('boolean_op', executeBooleanOpNode as LogicExecutorHandler);
    this.registerHandler('math_op', executeMathOpNode as LogicExecutorHandler);
    this.registerHandler('duplicate', executeDuplicateNode as LogicExecutorHandler);
