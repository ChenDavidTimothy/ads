...
export class AnimationNodeExecutor extends BaseExecutor {
  protected registerHandlers(): void {
    this.registerHandler('animation', executeAnimationNode as AnimationExecutorHandler);
    this.registerHandler('typography', executeTypographyNode as AnimationExecutorHandler);
