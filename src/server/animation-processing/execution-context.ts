...
export function pushExecutionStack(context: ExecutionContext, nodeId: string): void {
  context.executionStack.push(nodeId);
}

export function popExecutionStack(context: ExecutionContext): string | undefined {
...
export function validateExecutionValue(value: unknown, expectedType: ExecutionDataType): boolean {
  switch (expectedType) {
    case 'boolean':
...
export function coerceExecutionValue(value: unknown, targetType: ExecutionDataType): unknown {
  switch (targetType) {
    case 'boolean':
