          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="space-y-8 text-[var(--text-secondary)]">
              ...
              <section>
                ...
                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2">2.1 Personal Information</h3>
                <p>
                ...
                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2 mt-4">2.2 Usage Data</h3>
                <p>
                ...
                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2 mt-4">2.3 Content Data</h3>
                <p>
                  We store and process the content you create using our Service, including:
                </p>
                <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  ...
                  <li><strong>Communication:</strong> To send important service updates and respond to inquiries</li>
              ...
              <section>
                ...
                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2">4.1 Service Providers</h3>
                <p>
                ...
                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2 mt-4">4.2 Legal Requirements</h3>
                <p>
                ...
                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2 mt-4">4.3 Business Transfers</h3>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">6. Data Retention</h2>
                <p>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  ...
                  <li><strong>Content Data:</strong> Retained according to your storage plan and deletion requests</li>
              ...
              <section>
                <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">7. Your Rights and Choices</h2>
                <p>
                  Depending on your location, you may have certain rights regarding your personal information:
                </p>

                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2">7.1 Access and Portability</h3>
                <p>
                  You can access and download your personal information and content through your account settings.
                </p>

                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2 mt-4">7.2 Correction and Updates</h3>
                <p>
                  You can update your personal information through your account settings or by contacting us.
                </p>

                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2 mt-4">7.3 Deletion</h3>
                <p>
                  You can request deletion of your account and associated data. Some information may be retained for legal compliance.
                </p>

                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2 mt-4">7.4 Marketing Communications</h3>
                <p>
                  You can opt out of marketing communications by using the unsubscribe link in emails or updating your preferences.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">8. Cookies and Tracking Technologies</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">9. International Data Transfers</h2>
                <p>
                  Your information may be transferred to and processed in countries other than your residence. We ensure appropriate safeguards are in place to protect your information, including:
                </p>
                <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">11. Changes to This Privacy Policy</h2>
                <p>
                ...
                <p className="mt-2">
                  Changes are effective when posted on this page. Your continued use of the Service after changes constitutes acceptance of the updated Privacy Policy.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">12. Contact Us</h2>
                <p>
                ...
                <p>
                  If you are located in the European Union or United Kingdom, you have additional rights under GDPR and UK GDPR. You may contact our Data Protection Officer or your local supervisory authority with any concerns.
                </p>

                <h3 className="text-lg font-medium text-[var(--text-primary)] mb-2 mt-4">California Residents</h3>
                <p>
