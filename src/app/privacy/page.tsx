      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className="rounded-xl border border-[var(--glass-border)] bg-[var(--glass-bg)] p-8 backdrop-blur-sm">
          <div className="prose prose-invert max-w-none">
            <h1 className="mb-8 text-3xl font-bold text-[var(--text-primary)]">Privacy Policy</h1>
            ...
            <div className="space-y-8 text-[var(--text-secondary)]">
              <section>
                ...
                <p>
                  Variota (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is committed to
                  protecting your privacy. This Privacy Policy explains how we collect, use,
                  disclose, and safeguard your information when you use our no-code animation
                  platform and services (&ldquo;Service&rdquo;).
                </p>
                <p className="mt-2">
              ...
              <section>
                ...
                <p>We store and process the content you create using our Service, including:</p>
                <ul className="mt-2 list-disc space-y-1 pl-6">
              ...
              <section>
                ...
                <ul className="mt-2 list-disc space-y-1 pl-6">
                  ...
                  <li>
                    <strong>Account Management:</strong> To create and manage your account and
                    preferences
                  </li>
                  <li>
                    <strong>Communication:</strong> To send important service updates and respond to
                    inquiries
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Analytics:</strong> To understand usage patterns and improve user
                    experience
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Marketing:</strong> To send promotional content (with your consent)
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p>
                  We may share information with third-party service providers who help us operate
                  our Service, such as:
                </p>
                <ul className="mt-2 list-disc space-y-1 pl-6">
              ...
              <section>
                ...
                <ul className="mt-2 list-disc space-y-1 pl-6">
                  ...
                  <li>
                    <strong>Content Data:</strong> Retained according to your storage plan and
                    deletion requests
                  </li>
                  <li>
                    <strong>Usage Data:</strong> Typically retained for up to 2 years for analytics
                    purposes
                  </li>
                  <li>
              ...
              <section>
                ...
                <p>
                  You can access and download your personal information and content through your
                  account settings.
                </p>
              ...
              <section>
                ...
                <p>
                  ...
                  residence. We ensure appropriate safeguards are in place to protect your
              ...
              <section>
                ...
                <p className="mt-2">
                  Changes are effective when posted on this page. Your continued use of the Service
              ...
              <section>
                ...
                <p>
                  If you are located in the European Union or United Kingdom, you have additional
                  rights under GDPR and UK GDPR. You may contact our Data Protection Officer or your
                  local supervisory authority with any concerns.
                </p>
                ...
                <p>
                  ...
                  Consumer Privacy Act (CCPA). Please contact us for more information about
            ...
            <div className="mt-12 border-t border-[var(--border-primary)] pt-8">
              <p className="text-sm text-[var(--text-tertiary)]">
                This Privacy Policy is effective as of the last updated date. For questions or
                concerns about your privacy, please contact our privacy team at privacy@variota.com.
              </p>
            </div>
          </div>
        </div>
