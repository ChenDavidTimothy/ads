      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className="rounded-xl border border-[var(--glass-border)] bg-[var(--glass-bg)] p-8 backdrop-blur-sm">
          <div className="prose prose-invert max-w-none">
            <h1 className="mb-8 text-3xl font-bold text-[var(--text-primary)]">Terms of Service</h1>
            ...
            <div className="space-y-8 text-[var(--text-secondary)]">
              <section>
                ...
                <p>
                  By accessing and using Variota (&ldquo;Service&rdquo;), you accept and agree to be
              ...
              <section>
                ...
                <p>
                  Variota is a no-code animation platform that enables users to create dynamic,
                  data-driven video content through a visual programming interface. The
                  &ldquo;Service&rdquo; includes:
                </p>
              ...
              <section>
                ...
                <p>
                  ...
                  Service, you grant us a limited, non-exclusive license to process, store, and
                ...
                <p>
                  ...
                  owned by Variota and is protected by intellectual property laws. You may not copy,
              ...
              <section>
                ...
                <p>
                  Variota offers both free and paid subscription plans. Free plans have limitations
                  on features and usage. Paid plans provide additional features and higher usage
                  limits.
                </p>
                ...
                <p>
                  Paid subscriptions are billed in advance and will automatically renew unless
                  cancelled. You may cancel your subscription at any time through your account
                  settings. Refunds are provided according to our refund policy.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  We strive to maintain the availability of the Service but cannot guarantee
              ...
              <section>
                ...
                <p>
                  To the maximum extent permitted by law, Variota shall not be liable for any
              ...
              <section>
                ...
                <p>
                  You agree to defend, indemnify, and hold harmless Variota from and against any
              ...
              <section>
                ...
                <p>
                  ...
                  [Jurisdiction]. Any disputes arising under these Terms shall be resolved through
            ...
            <div className="mt-12 border-t border-[var(--border-primary)] pt-8">
              <p className="text-sm text-[var(--text-tertiary)]">
                These Terms of Service are effective as of the last updated date and replace any
                prior agreements. For questions or concerns, please contact our legal team at
                legal@variota.com.
              </p>
            </div>
          </div>
