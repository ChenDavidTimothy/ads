  ...
  return (
    <div className={`border-b border-[var(--border-primary)] ${className}`}>
      <button
        ...
        className="flex w-full cursor-pointer items-center justify-between p-[var(--space-3)] text-left transition-colors hover:bg-[var(--surface-interactive)]"
        type="button"
      >
      ...
      {isExpanded && <div className="px-[var(--space-3)] pb-[var(--space-3)]">{children}</div>}
    </div>
  );
}
