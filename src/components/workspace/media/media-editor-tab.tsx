...
import { MediaDefaultProperties } from './media-default-properties';
import { MediaPerObjectProperties } from './media-per-object-properties';
...
export function MediaEditorTab({ nodeId }: { nodeId: string }) {
  ...
  useEffect(() => {
    console.log(
      `[Media] Detected ${upstreamObjects.length} image objects for Media node ${nodeId}:`,
