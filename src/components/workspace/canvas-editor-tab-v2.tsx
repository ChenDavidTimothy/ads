...
export function CanvasEditorTabV2({ nodeId }: { nodeId: string }) {
...
interface CanvasDefaultPropertiesV2Props {
  nodeId: string;
  canvasNode: any;
  propertyManager: any;
}

function CanvasDefaultPropertiesV2({ nodeId, canvasNode, propertyManager }: CanvasDefaultPropertiesV2Props) {
...
interface CanvasPerObjectPropertiesV2Props {
  nodeId: string;
  objectId: string;
  propertyManager: any;
  onClear: () => void;
...
function CanvasPerObjectPropertiesV2({ nodeId, objectId, propertyManager, onClear }: CanvasPerObjectPropertiesV2Props) {
